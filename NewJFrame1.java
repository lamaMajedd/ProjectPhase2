...
private void loadFilesList(){
    File lfl = new File (".");
    String[] fileList = lfl.list();
           for (String file : fileList) {
            if (file.endsWith(".ser")) {
                dcbm.addElement(file.substring(0, file.indexOf(".")));
            }
    ...
    private void initComponents() {
        ...
        jLabel9.setFont(new java.awt.Font("STC", 1, 36)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Exam Manger");
        jPanel4.add(jLabel9);
        jLabel9.setBounds(70, 30, 210, 40);

        jPanel6.setBackground(new java.awt.Color(255, 255, 255));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Open", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("STC", 0, 18), new java.awt.Color(50, 89, 127))); // NOI18N
        jPanel2.setForeground(new java.awt.Color(52, 96, 141));

        jLabel1.setFont(new java.awt.Font("STC", 0, 16)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(39, 54, 68));
        ...
        jLabel2.setForeground(new java.awt.Color(39, 54, 68));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/project/Untitled-14.png"))); // NOI18N
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(8, 8, 8)
                                .addComponent(newCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 249, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void openQActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openQActionPerformed
      ...
      dispose();
        ...
        if (!newCourse.getText().trim().equals("")) {
            course = newCourse.getText();
        } else {
            if (menu.getSelectedIndex() != -1) {
                course = "" + menu.getSelectedItem();
            }
        }
        QuestionBankViewerFrame.main(new String[]{course});
